        ...
        <div className="my-8 flex items-center justify-between">
          ...
          >
            <input
              ...
              className="w-full py-2 pl-10 pr-4 z-50 relative navbar-icon-bg-color border-2 border-[--cashier-main-color] rounded-full focus:outline-none  focus:ring-[--cashier-main-color] hover:bg-[--select-section] focus-within:bg-[--select-section]"
            />
