...
function MenuDetailsCardSlider({
  ...
  const getCardClasses = (position) => {
    ...
    switch (position) {
      case 'center':
        return `${baseClasses} scale-125 z-20 opacity-100 top-0 left-1/2 -translate-x-1/2`;
      case 'left':
        return `${baseClasses} scale-90 z-10 opacity-70 top-0 left-0 -translate-x-1/2`;
      case 'right':
        return `${baseClasses} scale-90 z-10 opacity-70 top-0 right-0 translate-x-1/2`;
      default:
          ...
          return (
            <div 
              ...
              style={{ 
                ...
                height: position === 'center' ? '440px' : '384px'
              }}
            >
              <div
                className={`max-w-sm bg-white rounded-3xl shadow-lg overflow-hidden ${
