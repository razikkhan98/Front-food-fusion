      ...
      <div className="bg-white p-6 rounded-2xl shadow-lg z-20 w-[540px] h-[440px]">
        ...
        <form className="text-center mt-14" onSubmit={handleSubmit(onSubmitHandler)}>
          ...
          <div className="relative">
            ...
            {/* Arrow Button */}
            {/* <NavLink to={"/home"}> */}
            <button type="submit" className="absolute right-7 top-3/4 transform -translate-y-3/4 flex justify-center items-center text-end w-10 h-10 rounded-full bg-gray-100
             text-gray-600">
              <svg
