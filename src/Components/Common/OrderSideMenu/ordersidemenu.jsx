...
const OrderSideMenu = () => {
  return (
    <>
      ...
      <div className="h-full py-3 w-80 ms-1 mt-3">
          ...
          <div>
            <div className="cashier-light-bg-color rounded-t-2xl p-3">
              <div className="flex justify-between text-sm font-semibold text-gray-700">
                ...
                <span className="text-color-gray text-sm font-medium px-2">Table No<span className="text-color-black">12</span> </span>
              </div>
            ...
            <div className="flex justify-between cashier-light-bg-color opacity-50 my-3 mx-2 p-1 rounded-md">
              {OrdertypeData.map((option, index) => (
                <button
                  key={index}
                  className={`px-2 text-sm font-normal text-center rounded-md ${option.isActive ? "bg-white" : "text-light-gray-color"
                    }`}
                >
                  {option.label}
                </button>
            ...
            <div className="flex justify-between mt-3 border-b pb-2 text-sm px-4">
                ...
                <div key={index} className="border-b pb-2">
                  ...
                  <div className="flex justify-between items-end">
                    <p className="flex w-3/4 text-light-gray-color text-sm font-normal mt-2">
                      <span className="bg-gray-100 h-5 w-5 rounded-full flex justify-center items-center me-2">
                    ...
                    <div className="text-right font-medium text-base text-color black">
                      ₹ {item.price}
                    </div>
                  </div>
                </div>
