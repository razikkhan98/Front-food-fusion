      ...
      <div className=" flex flex-col items-center justify-center">
        ...
        <div className="relative w-full">
          ...
          {filteredOptions?.length >= 0 && (
            <ul ref={dropdownRef} className={`absolute left-0 top-[-20px] w-full auto-suggest overflow-y-scroll hidden-scroll bg-white border-t-0 rounded-lg rounded-t-none card-box-shadow z-10 ${showDropdown? "" : ""}`}>
              <li className="h-4"></li>
